...
```{r cargar, eval=FALSE, echo=FALSE}
...
2. Funciones "que sean fáciles de recordar" significa que sus nombres y argumentos están escritos en el idioma nativo de quien las usa; en este caso, el "español" (castellano).
...
# Eliminemos primero el objeto "mis_cosas" del entorno global para apreciar como trabaja `listar()`
...
# Ahora creamos la lista, añadimos el objeto y lo eliminamos del entorno global, en una sola instrucción
...
# Agregamos a la lista, en el primer lugar y eliminamos el objeto del entorno global para que no esté duplicado
